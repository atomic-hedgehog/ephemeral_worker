...
cljs.core.with_meta = function with_meta(b, c) {
  ...
  return d ? with_meta.call(null, function() {
    if(void 0 === cljs.core.t4128) {
      cljs.core.t4128 = {};
      cljs.core.t4128 = function(b, c, d, e) {
        this.meta = b;
        this.o = c;
        this.with_meta = d;
        this.meta4129 = e;
      ...
      cljs.core.t4128.cljs$lang$type = !0;
      cljs.core.t4128.cljs$lang$ctorStr = "cljs.core/t4128";
      cljs.core.t4128.cljs$lang$ctorPrWriter = function(b, c) {
        return cljs.core._write.call(null, c, "cljs.core/t4128")
      };
      var d = cljs.core.t4128.prototype, f = function(b, c) {
      ...
      d.call = g;
      cljs.core.t4128.prototype.apply = function(b, c) {
        b = this;
        return b.call.apply(b, [b].concat(c.slice()))
      };
      cljs.core.t4128.prototype.cljs$core$Fn$ = !0;
      cljs.core.t4128.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta4129
      };
      cljs.core.t4128.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
        return new cljs.core.t4128(this.meta, this.o, this.with_meta, c)
      }
    }
    return new cljs.core.t4128(c, b, with_meta, null)
...
var ephemeral_worker = {worker:{}};
ephemeral_worker.worker.post_status = function(a) {
  return postMessage(a)
};
ephemeral_worker.worker.starting_state = cljs.core.atom.call(null, "\ufdd0:not-started");
ephemeral_worker.worker.transition = function() {
  ...
  return new cljs.core.MultiFn("transition", cljs.core.identity, "\ufdd0:default", e, a, b, c, d)
}();
cljs.core._add_method.call(null, ephemeral_worker.worker.transition, "\ufdd0:not-started", function() {
  return"\ufdd0:started"
});
cljs.core._add_method.call(null, ephemeral_worker.worker.transition, "\ufdd0:started", function() {
  return"\ufdd0:running"
});
cljs.core._add_method.call(null, ephemeral_worker.worker.transition, "\ufdd0:running", function() {
  return"\ufdd0:finished"
});
cljs.core._add_method.call(null, ephemeral_worker.worker.transition, "\ufdd0:default", function() {
  return"\ufdd0:finished"
});
ephemeral_worker.worker.still_running_QMARK_ = function(a) {
  return cljs.core.not_EQ_.call(null, a, "\ufdd0:finished")
};
ephemeral_worker.worker.process_current_state = function(a) {
  return ephemeral_worker.worker.transition.call(null, a)
};
ephemeral_worker.worker.work = function(a) {
  for(;;) {
    if(cljs.core.truth_(ephemeral_worker.worker.still_running_QMARK_.call(null, cljs.core.deref.call(null, a)))) {
      cljs.core.swap_BANG_.call(null, a, ephemeral_worker.worker.process_current_state), ephemeral_worker.worker.post_status.call(null, cljs.core.deref.call(null, a))
    }else {
      return null
    }
  }
};
ephemeral_worker.worker.work.call(null, ephemeral_worker.worker.starting_state);
