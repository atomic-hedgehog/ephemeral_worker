...
var ephemeral_worker = {client:{}};
ephemeral_worker.client.log = function(a) {
  return console.log([cljs.core.str("[worker] "), cljs.core.str(a)].join(""))
};
ephemeral_worker.client.handler = function(a) {
  return console.log("" + cljs.core.str(a))
};
ephemeral_worker.client.error_handler = function(a) {
  return console.log([cljs.core.str("ERROR: "), cljs.core.str(a)].join(""))
};
ephemeral_worker.client.worker_status = cljs.core.atom.call(null, cljs.core.PersistentArrayMap.fromArray(["\ufdd0:worker-state", "\ufdd0:not-started", "\ufdd0:uptime", 0, "\ufdd0:start-time", Date.now()], !0));
ephemeral_worker.client.update_uptime = function(a) {
  return cljs.core.swap_BANG_.call(null, a, cljs.core.merge, cljs.core.PersistentArrayMap.fromArray(["\ufdd0:uptime", Date.now() - (new cljs.core.Keyword("\ufdd0:start-time")).call(null, cljs.core.deref.call(null, a))], !0))
};
ephemeral_worker.client.pulse = function pulse() {
  ephemeral_worker.client.update_uptime.call(null, ephemeral_worker.client.worker_status);
  ajax.core.GET.call(null, "/", cljs.core.PersistentArrayMap.fromArray(["\ufdd0:params", cljs.core.deref.call(null, ephemeral_worker.client.worker_status), "\ufdd0:handler", ephemeral_worker.client.handler, "\ufdd0:error-handler", ephemeral_worker.client.error_handler], !0));
  return setTimeout(pulse, 1E3)
};
ephemeral_worker.client.pulse.call(null);
ephemeral_worker.client.on_worker_message = function(a) {
  return cljs.core.swap_BANG_.call(null, ephemeral_worker.client.worker_status, cljs.core.merge, cljs.core.PersistentArrayMap.fromArray(["\ufdd0:worker-state", a.data], !0))
};
ephemeral_worker.client.worker = new Worker("js/worker.js");
ephemeral_worker.client.worker.onmessage = ephemeral_worker.client.on_worker_message;
